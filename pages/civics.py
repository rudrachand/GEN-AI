...
PROMPT_TEMPLATE = """
You are a knowledgeable and friendly civics tutor for an 8th-grade student.
...
Explain your answer clearly and simply, using bullet points or short paragraphs if helpful. Focus on making the explanation easy to understand for an 8th-grade student.
...
# === Streamlit UI ===
st.set_page_config(page_title="📚 8th Class Chatbot for Civics", layout="wide")
st.title("🎓 8th Class Chatbot for Civics")
st.markdown("Ask your Civics questions based on 8th-grade CBSE textbooks and notes.")
st.info("📘 This chatbot is trained on 8th class Civics materials. Type your question below!")
...
user_query = st.text_input(
    "🔍 Enter your Civics question:",
    value=chosen_example if chosen_example else "",
    placeholder="E.g. Why does a democratic country need a Constitution?"
)
